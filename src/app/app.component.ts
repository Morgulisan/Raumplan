...
export class AppComponent {
  ...
  Dates: [
    {dateDay : {Y: 2020, M: 4, D: 6}, dateTime: 7.5 , dateDuration: 4, Room: 'Dom', owner: 'Malte Kretzschmar', name: 'S1'},
    {dateDay : {Y: 2020, M: 4, D: 6}, dateTime: 9.5 , dateDuration: 6, Room: 'Dom', owner: 'Malte Kretzschmar', name: 'S2'},
